...
int tracking(string thestring, double iterNbX, double iterNbY, double shiREF1X, double shiREF1Y, double shiREF2X, double shiREF2Y, double shiREF3X, double shiREF3Y, double shiEta5, double Trk1Pos, double Trk2Pos, double Trk3Pos, double GEMPos , double aREF2REF1, double aREF3REF1 ){
  ...
  /* 
    ...
    */
    ...
    double preshiREF1X=-2540.0, preshiREF1Y=-500.;
    double preshiREF2X=-2540.0, preshiREF2Y=-500.;  //2127.4275
    double preshiREF3X=-2540.0, preshiREF3Y=-500.;
    double preshiEta5 =-500.;
	...
	if(verbose)
	cout<<"====== "<<d.vpREF1X<<"\t"<<d.vpREF1Y<<"\t"<<d.vpREF2X<<"\t"<<d.vpREF2Y<<"\t"<<d.vpREF3X<<"\t"<<d.vpREF3Y<<"\t"<<d.vpEta5<<endl;
        //shift
	...
	//d.vpEta5  -= preshiEta5; 
      ...
      residualREF1X = new TH1F(nameRes1X,"",200,-2,2); residualREF1X->SetXTitle("Residual in r [mm]"); residualREF1X->SetYTitle("Frequency");residualREF1X->SetLabelSize(0.05,"XY");residualREF1X->SetTitleSize(0.05,"XY");
      residualREF1Y = new TH1F(nameRes1Y,"",200,-2,2); residualREF1Y->SetXTitle("Residual in #phi [rad]"); residualREF1Y->SetYTitle("Frequency");residualREF1Y->SetLabelSize(0.05,"XY");residualREF1Y->SetTitleSize(0.05,"XY");
      residualREF2X = new TH1F(nameRes2X,"",200,-2,2); residualREF2X->SetXTitle("Residual in r [mm]"); residualREF2X->SetYTitle("Frequency");residualREF2X->SetLabelSize(0.05,"XY");residualREF2X->SetTitleSize(0.05,"XY");
      residualREF2Y = new TH1F(nameRes2Y,"",200,-2,2); residualREF2Y->SetXTitle("Residual in #phi [rad]"); residualREF2Y->SetYTitle("Frequency");residualREF2Y->SetLabelSize(0.05,"XY");residualREF2Y->SetTitleSize(0.05,"XY");
      residualREF3X = new TH1F(nameRes3X,"",200,-2,2); residualREF3X->SetXTitle("Residual in r [mm]"); residualREF3X->SetYTitle("Frequency");residualREF3X->SetLabelSize(0.05,"XY");residualREF3X->SetTitleSize(0.05,"XY");
      residualREF3Y = new TH1F(nameRes3Y,"",200,-2,2); residualREF3Y->SetXTitle("Residual in #phi [rad]"); residualREF3Y->SetYTitle("Frequency");residualREF3Y->SetLabelSize(0.05,"XY");residualREF3Y->SetTitleSize(0.05,"XY");
      residualEta5 = new TH1F(nameResEta5,"",200,-10,10); residualEta5->SetXTitle("Residual in #phi [rad]"); residualEta5->SetYTitle("Frequency");residualEta5->SetLabelSize(0.05,"XY");residualEta5->SetTitleSize(0.05,"XY");
...
*/
      ...
      fout1<<fixed<<setprecision(7)<<"\t"<<meanEta5<<"\t"<<sigmaEta5<<"\t"<<meanXChi2<<"\t"<<meanYChi2<<"\t"<<totalChi2<<endl;
//      fout1<<std::setprecision(5)<<preshiREF2X<<"\t"<<preshiREF2Y<<"\t"<<meanEta5<<"\t"<<sigmaEta5<<"\t"<<meanXChi2<<"\t"<<meanYChi2<<"\t"<<totalChi2<<endl;
      cout<<fixed<<setprecision(1)<<"\033[1;31m"<<iterNbX<<"\t"<<iterNbY<<"\t"<<preshiREF2X<<"\t"<<preshiREF2Y;
      cout<<fixed<<setprecision(7)<<"\t"<<meanEta5<<"\t"<<sigmaEta5<<"\t"<<meanXChi2<<"\t"<<meanYChi2<<"\t"<<totalChi2<<"\033[0m\n"<<endl;
 fout1.close();
 fout2.close();
 return 0;
} // entire script
